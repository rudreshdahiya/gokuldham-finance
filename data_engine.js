...
const DATA_ENGINE_CORE = {
    ...
    ALL_GOALS: {
        "FG001": { id: "FG001", label: "Emergency Fund", category: "Essential", horizon: "Short", cost: "₹3-12L", priority: "Critical", primer: "Buffer for job loss or medical crises.", tax_efficiency: "Liquid Funds (Taxed at slab)." },
        "FG002": { id: "FG002", label: "Health Insurance", category: "Essential", horizon: "Short", cost: "₹20-60k/yr", priority: "Critical", primer: "Cover hospital bills without breaking FDs.", tax_efficiency: "Section 80D deduction available." },
        ...
        "FG006": { id: "FG006", label: "FIRE (Retire Early)", category: "Lifestyle", horizon: "Long", cost: "₹3.75-5Cr", priority: "High", primer: "Freedom from 9-to-5 loop.", tax_efficiency: "LTCG on Equity < 1.25L is tax free." },
        ...
        "FG013": { id: "FG013", label: "Sabbatical (Break)", category: "Lifestyle", horizon: "Short", cost: "₹2-5L", priority: "Medium", primer: "6-month expense coverage.", tax_efficiency: "Use Liquid Funds." },
        ...
        "FG015": { id: "FG015", label: "Intl Family Vacation", category: "Lifestyle", horizon: "Short", cost: "₹3-8L", priority: "Medium", primer: "Annual trip abroad.", tax_efficiency: "TCS applies on forex > 7L." },
        ...
        "FG032": { id: "FG032", label: "Skill Upgrade (MBA/CFA)", category: "Wealth", horizon: "Short", cost: "₹1-10L", priority: "High", primer: "Investing in yourself.", tax_efficiency: "Education loan interest deduction." },
